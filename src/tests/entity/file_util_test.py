...
class TestLoader(unittest.TestCase):
    ...
    def test_dec_cursor(self):
        ...
        for i in range(len(self.loader.states)):
            ...
            self.assertEqual(self.loader.cursor, max(
                0, len(self.loader.states) - i - 2))
    ...
    def test_inc_cursor(self):
        ...
        for i in range(len(self.loader.states) + 1):
            ...
            self.assertEqual(self.loader.cursor, min(
                len(self.loader.states) - 1, i + 1))
    ...
    def test_add(self):
        ...
        for i in range(N_SQUARES):
            self.assertEqual(board.get_piece_on_square(
                i), self.loader.states[len(self.loader.states) - 1].get_piece_on_square(i))
